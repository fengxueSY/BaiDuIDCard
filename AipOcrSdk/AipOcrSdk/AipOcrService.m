...
- (void)detectDrivingLicenseFromImage:(UIImage *)image withOptions:(NSDictionary *)options successHandler:(void (^)(id result))successHandler failHandler:(void (^)(NSError *err))failHandler {
    [_aipOcrManager detectDrivingLicenseFromImage:image withOptions:options successHandler:successHandler failHandler:^(NSError *error){
        if(self.retry){
            [_aipOcrManager detectDrivingLicenseFromImage:image withOptions:options successHandler:successHandler failHandler:failHandler];
        }else{
            if (failHandler) failHandler(error);
        }
    }];
...
- (void)detectVehicleLicenseFromImage:(UIImage *)image withOptions:(NSDictionary *)options successHandler:(void (^)(id result))successHandler failHandler:(void (^)(NSError *err))failHandler {
    [_aipOcrManager detectVehicleLicenseFromImage:image withOptions:options successHandler:successHandler failHandler:^(NSError *error){
        if(self.retry){
            [_aipOcrManager detectVehicleLicenseFromImage:image withOptions:options successHandler:successHandler failHandler:failHandler];
        }else{
            if (failHandler) failHandler(error);
        }
    }];
...
- (void)detectPlateLicenseFromImage:(UIImage *)image withOptions:(NSDictionary *)options successHandler:(void (^)(id result))successHandler failHandler:(void (^)(NSError *err))failHandler {
    [_aipOcrManager detectPlateLicenseFromImage:image withOptions:options successHandler:successHandler failHandler:^(NSError *error){
        if(self.retry){
            [_aipOcrManager detectPlateLicenseFromImage:image withOptions:options successHandler:successHandler failHandler:failHandler];
        }else{
            if (failHandler) failHandler(error);
        }
    }];
